...
import static algorithms.metaProcessors.FileContentConverter.bytesToIntegers;

public class Channels_old implements Channeling {
	...
	public Channels_old(int numberOfChannels) {
	...
	private Channels_old(int numberOfChannels, int index) {
		...
		if (numberOfChannels > 0) {
			channelIndex = index;
			nextChannel = new Channels_old(--numberOfChannels, ++index);
		}
	...
	Channels_old(byte[] source, int blockAlign, int numberOfChannels) {
