...
/*	@Test
	public void getSourceTest_0() {
		...
		for (Integer i : strip_1) input_0._channelList.get(0).addSampling(AudioData.newInstance(i));
		for (Integer i : strip_2) input_0._channelList.get(1).addSampling(AudioData.newInstance(i));
		for (Integer i : strip_3) input_0._channelList.get(2).addSampling(AudioData.newInstance(i));
