...
//	--------------------------------------------------------------------------------------------------------------------
	...
	public void consolidateChannelsTest_0() {
		...
		for (Integer i : strip_1) input_0.strips.get(0).addSample(Sampleable.instanceOf(i));
		for (Integer i : strip_2) input_0.strips.get(1).addSample(Sampleable.instanceOf(i));
		for (Integer i : strip_3) input_0.strips.get(2).addSample(Sampleable.instanceOf(i));
...
//	@Test
	public void importToStripsTest_0(){
		...
		for (Integer i : strip_1) correct.strips.get(0).addSample(Sampleable.instanceOf(i));
		for (Integer i : strip_2) correct.strips.get(1).addSample(Sampleable.instanceOf(i));
		for (Integer i : strip_3) correct.strips.get(2).addSample(Sampleable.instanceOf(i));
